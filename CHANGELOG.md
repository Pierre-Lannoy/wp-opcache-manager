...
- [WPCLI] The result of `wp opcache` commands are now logged in [DecaLog](https://wordpress.org/plugins/decalog/).

### Changed
- Improved ephemeral cache in analytics.
- [WPCLI] The result of `wp opcache` commands are now prefixed by the product name.
