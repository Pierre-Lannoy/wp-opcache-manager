		...
		public static function initialize() {
			foreach ( apply_filters( 'init_perfops_admin_menus', [] ) as $menu => $submenus ) {
				if ( ! in_array( 'perfopsone-' . $menu, self::$slugs, true ) ) {
					switch ( $menu ) {
						case 'analytics':
							add_menu_page( esc_html__( 'Dashboard', 'opcache-manager' ), sprintf( esc_html__( '%s Analytics', 'opcache-manager' ), 'PerfOps' ), 'manage_options', 'perfopsone-' . $menu, [ self::class, 'get_analytics_page' ], 'dashicons-chart-bar', 6666 );
							...
							break;
						case 'tools':
							add_menu_page( esc_html__( 'Available Tools', 'opcache-manager' ), sprintf( esc_html__( '%s Tools', 'opcache-manager' ), 'PerfOps' ), 'manage_options', 'perfopsone-' . $menu, [ self::class, 'get_tools_page' ], 'dashicons-admin-tools', 6666 );
							...
							break;
						case 'insights':
							add_menu_page( esc_html__( 'Available Reports', 'opcache-manager' ), sprintf( esc_html__( '%s Insights', 'opcache-manager' ), 'PerfOps' ), 'manage_options', 'perfopsone-' . $menu, [ self::class, 'get_insights_page' ], 'dashicons-lightbulb', 6666 );
							...
							break;
						case 'records':
							add_menu_page( esc_html__( 'Available Catalogues', 'opcache-manager' ), sprintf( esc_html__( '%s Records', 'opcache-manager' ), 'PerfOps' ), 'manage_options', 'perfopsone-' . $menu, [ self::class, 'get_records_page' ], 'dashicons-book', 6666 );
							...
							break;
						case 'settings':
							add_menu_page( esc_html__( 'Control Center', 'opcache-manager' ), sprintf( esc_html__( '%s Settings', 'opcache-manager' ), 'PerfOps' ), 'manage_options', 'perfopsone-' . $menu, [ self::class, 'get_settings_page' ], 'dashicons-admin-settings', 6666 );
							...
							break;
						case 'consoles':
							add_menu_page( esc_html__( 'Available Consoles', 'opcache-manager' ), sprintf( esc_html__( '%s Consoles', 'opcache-manager' ), 'PerfOps' ), 'manage_options', 'perfopsone-' . $menu, [ self::class, 'get_consoles_page' ], 'dashicons-embed-generic', 6666 );
							add_submenu_page( 'perfopsone-' . $menu, esc_html__( 'Available Consoles', 'opcache-manager' ), __( 'Available Consoles', 'opcache-manager' ), 'manage_options', 'perfopsone-' . $menu, [ self::class, 'get_sconsoles_page' ], 0 );
							break;
					}
